...
!*******************************************************************************
      ...
      REAL(4),PARAMETER :: LLIM_X      = -10.0
      ! right limit of interpolation interval
      REAL(4),PARAMETER :: RLIM_X      = 10.0

      REAL(4),PARAMETER :: FFREQ       = 1.75
      ...
      errcode = dfssearchcells1d( task, method, nsite, site,             &
     &      sitehint, cell=cell )
      CALL CheckDfError(errcode)
     ...
     &      ic_type=ic_type, scoeff=scoeff, scoeffhint=scoeffhint )
      ...
      method = DF_METHOD_STD
      errcode = dfsconstruct1d( task, comp_type, method )
      CALL CheckDfError(errcode)
      ...
      ndorder = 1
      dorder(1) = 1
      errcode = dfsinterpolate1d( task, comp_type, method, nsite, site,  &
