...
! Content:
!       Example of using sfftw_plan_dft_r2c function.
!
!*****************************************************************************

program sp_plan_dft_r2c
  ...
  call sfftw_plan_dft_r2c(plan_r2c, 4, N(1:4), x_real, x_cmplx, FFTW_ESTIMATE)
