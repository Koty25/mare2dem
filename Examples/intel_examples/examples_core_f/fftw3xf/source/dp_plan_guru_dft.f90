...
! Content:
!       Example of using dfftw_plan_guru_dft function.
!
!*****************************************************************************
program dp_plan_guru_dft
  ...
  print *,"Example dp_plan_guru_dft"
  ...
  call dfftw_plan_guru_dft(fwd, 3, (/N1,N2,N3/), istride, ostride,  &
                           1, M, idist, odist , x, y,               &
  ...
  call dfftw_execute_dft(fwd, x, y)
        ...
        do k3 = 1, N3
          do mm = 1, M
            ...
            if (.not.(err < errthr)) then
              ...
              print '(" expected ("G24.17","G24.17")"$)', x_exp
              print '(" got ("G24.17","G24.17")"$)', x_got
              print '(" err "G10.3)', err
