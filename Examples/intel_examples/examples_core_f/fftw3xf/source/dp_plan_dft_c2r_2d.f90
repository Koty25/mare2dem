...
! Content:
!       Example of using dfftw_plan_dft_c2r_2d function.
!
!*****************************************************************************

program dp_plan_dft_c2r_2d
  ...
  print *,"Example dp_plan_dft_c2r_2d"
  ...
  call dfftw_plan_dft_c2r_2d(plan_c2r, N1, N2, x_cmplx, x_real, FFTW_ESTIMATE)
...
end program dp_plan_dft_c2r_2d
