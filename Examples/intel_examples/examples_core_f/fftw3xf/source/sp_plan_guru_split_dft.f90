...
! Content:
!       Example of using sfftw_plan_guru_split_dft function.
!
!*****************************************************************************
program sp_plan_guru_split_dft
  ...
  print *,"Example sp_plan_guru_split_dft"
  ...
  call sfftw_plan_guru_split_dft(plan, &
  ...
  call sfftw_execute_split_dft(plan, x_im, x_re, x_im, x_re)
  ...
  integer function verificate(x_re, x_im, N1, N2, N3, M, H1, H2, H3)
    ...
    &          mod  (k3-1-H3,N3)==0) then
            ...
            if (.not.(err < errthr)) then
              ...
              print '(" expected ("G14.7","G14.7"),"$)', re_exp, im_exp
              print '(" got ("G14.7","G14.7"),"$)', re_got, im_got
              print '(" err "G10.3)', err
...
end program sp_plan_guru_split_dft
