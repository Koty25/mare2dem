...
! Content:
!       Example of using dfftw_plan_many_dft_r2c function.
!
!*****************************************************************************
program dp_plan_many_dft_r2c
  ...
  integer, parameter :: M = 10 ! howmany
  ...
  print *,"Example dp_plan_many_dft_r2c"
  ...
  call dfftw_plan_many_dft_r2c(plan_r2c, 3, (/N1, N2, N3/), M, &
  ...
  call dfftw_plan_many_dft_c2r(plan_c2r, 3, (/N1, N2, N3/), M, &
...
end program dp_plan_many_dft_r2c
