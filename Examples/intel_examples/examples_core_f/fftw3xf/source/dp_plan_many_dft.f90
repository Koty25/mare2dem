...
! Content:
!       Example of using dfftw_plan_many_dft function.
!
!*****************************************************************************
program dp_plan_many_dft
  ...
  print *,"Example dp_plan_many_dft"
  ...
  call dfftw_plan_many_dft(fwd, 3, (/N1, N2, N3/), M, &
                           x, nembed, stride, dist,   &
                           x, nembed, stride, dist,   &
                           FFTW_FORWARD, FFTW_ESTIMATE)
  if (0 == fwd) goto 999

  call dfftw_plan_many_dft(bwd, 3, (/N1, N2, N3/), M, &
                           x, nembed, stride, dist,   &
                           x, nembed, stride, dist,   &
