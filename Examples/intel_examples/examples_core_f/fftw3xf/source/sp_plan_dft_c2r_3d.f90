...
! Content:
!       Example of using sfftw_plan_dft_c2r_3d function.
!
!*****************************************************************************

program sp_plan_dft_c2r_3d
  ...
  print *,"Example sp_plan_dft_c2r_3d"
  ...
  call sfftw_plan_dft_c2r_3d(c2r, N1, N2, N3, x_cmplx, x_cmplx, FFTW_ESTIMATE)
  if (0 == c2r) goto 999
...
end program sp_plan_dft_c2r_3d
