...
! Content:
!       Example of using dfftw_plan_dft_c2r function.
!
!*****************************************************************************

program dp_plan_dft_c2r
  ...
  call dfftw_plan_dft_c2r(plan_c2r, 4, N(1:4), x_cmplx, x_real, FFTW_ESTIMATE)
  ...
  call dfftw_execute_dft_c2r(plan_c2r, x_cmplx, x_real)
