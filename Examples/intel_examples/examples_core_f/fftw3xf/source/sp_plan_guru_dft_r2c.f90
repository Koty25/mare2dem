...
! Content:
!       Example of using sfftw_plan_guru_dft_r2c function.
!
!*****************************************************************************
program sp_plan_guru_dft_r2c
  ...
  print *,"Example sp_plan_guru_dft_r2c"
  print *,"Multiple 3D real-to-complex and complex-to-real transforms"
  ...
  call sfftw_plan_guru_dft_r2c(r2c,    &
  ...
  call sfftw_plan_guru_dft_c2r(c2r,    &
  ...
  call sfftw_execute_dft_r2c(r2c, x_real, x_cmplx)
  ...
  ! FFTW recommends to use new-array functions here for compiler not to move this call
  call sfftw_execute_dft_c2r(c2r, x_cmplx, x_real)
...
100 continue
  ...
  call sfftw_destroy_plan(r2c)
  call sfftw_destroy_plan(c2r)
...
end program sp_plan_guru_dft_r2c
