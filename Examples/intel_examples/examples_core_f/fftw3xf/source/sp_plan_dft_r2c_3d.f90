...
! Content:
!       Example of using sfftw_plan_dft_r2c_3d function.
!
!*****************************************************************************

program sp_plan_dft_r2c_3d
  ...
  print *,"Example sp_plan_dft_r2c_3d"
  ...
  call sfftw_plan_dft_r2c_3d(r2c, N1, N2, N3, x_real, x_real, FFTW_ESTIMATE)
  if (0 == r2c) goto 999
...
end program sp_plan_dft_r2c_3d
