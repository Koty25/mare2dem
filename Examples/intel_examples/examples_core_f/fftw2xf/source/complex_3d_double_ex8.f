...
!
! Complex-to-complex 3D transform for COMPLEX*16 data not inplace with strides
! and threads
!
...
!*****************************************************************************
      ...
      PROGRAM COMPLEX_3D_DOUBLE_EX8

      INCLUDE 'fftw_f77.i'
      INCLUDE 'mkl_fftw_examples.fi'

      INTEGER SIZE,N,M,L,IDIST,ODIST,ISTRIDE,OSTRIDE,HOWMANY,NTHREADS
      INTEGER I,STATUS
      PARAMETER (M=5)
      PARAMETER (N=8)
      PARAMETER (L=3)
