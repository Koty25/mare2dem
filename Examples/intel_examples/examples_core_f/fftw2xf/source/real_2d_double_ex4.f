...
!*****************************************************************************
      ...
      PROGRAM REAL_2D_DOUBLE_EX4

      INCLUDE 'fftw_f77.i'
      INCLUDE 'mkl_fftw_examples.fi'

      INTEGER SIZE,N,M,OUT_N,IDIST,ODIST,ISTRIDE,OSTRIDE,HOWMANY,I
      PARAMETER (M=5)
      PARAMETER (N=8)
...
!
      ...
      CALL RFFTWND_F77_REAL_TO_COMPLEX(MY_PLAN,HOWMANY,
...
!
      ...
      CALL RFFTWND_F77_COMPLEX_TO_REAL(MY_PLAN,HOWMANY,
...
!
      ...
      SCALE=1.0D0/(N*M)
      CALL SCALE_WITH_STRIDES_D(IN,SCALE,HOWMANY,N*M,ISTRIDE,IDIST)
