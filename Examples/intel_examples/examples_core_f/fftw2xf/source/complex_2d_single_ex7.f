...
!
! Complex-to-complex 2D transform for COMPLEX*8 data inplace with strides
! and threads
!
...
!*****************************************************************************
      ...
      INTEGER SIZE,N,M,IDIST,ISTRIDE,HOWMANY,NTHREADS,I,STATUS
      PARAMETER (M=5)
      PARAMETER (N=8)
      PARAMETER (ISTRIDE=2)
...
!
      ...
      CALL SCALE_WITH_STRIDES_C(IN,SCALE,HOWMANY,N*M,ISTRIDE,IDIST)
