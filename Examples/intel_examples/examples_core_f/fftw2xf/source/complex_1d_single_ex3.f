...
!
! Complex-to-complex 1D transform for COMPLEX*8 data inplace with strides
!
...
!*****************************************************************************
      ...
      INTEGER SIZE,N,IDIST,ISTRIDE,HOWMANY,I
      PARAMETER (N=10)
      PARAMETER (ISTRIDE=2)
      ...
      COMPLEX*8 IN(SIZE),OUT(N),EXP_X(SIZE)
      REAL*4 ERR,SCALE
...
!
      ...
      CALL FFTW_F77(MY_PLAN,HOWMANY,IN,ISTRIDE,IDIST,OUT,0,0)
