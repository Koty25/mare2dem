...
!
! Complex-to-complex 1D transform for COMPLEX*8 data not inplace with strides
! and threads
!
...
!*****************************************************************************
      ...
      INTEGER SIZE,N,IDIST,ODIST,ISTRIDE,OSTRIDE,HOWMANY,STATUS,NTHREADS
      INTEGER I
      PARAMETER (N=10)
      PARAMETER (ISTRIDE=2)
      PARAMETER (OSTRIDE=3)
...
!
      ...
      CALL FFTW_F77_THREADS(NTHREADS,MY_PLAN,HOWMANY,OUT,OSTRIDE,ODIST,
     *              IN,ISTRIDE,IDIST)
...
!
      ...
      SCALE=1.0/N
      CALL SCALE_WITH_STRIDES_C(IN,SCALE,HOWMANY,N,ISTRIDE,IDIST)
