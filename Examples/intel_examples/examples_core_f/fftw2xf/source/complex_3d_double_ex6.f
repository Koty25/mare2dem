...
!
! Complex-to-complex 3D transform for COMPLEX*16 data not inplace with threads
!
...
!*****************************************************************************
      ...
      COMPLEX*16 IN(N,M,L),OUT(N,M,L),EXP_X(N,M,L)
      REAL*8 ERR,SCALE
...
!
      ...
      CALL FFTWND_F77_THREADS_ONE(NTHREADS,MY_PLAN,IN,OUT)
...
!
      ...
      CALL FFTWND_F77_THREADS_ONE(NTHREADS,MY_PLAN,OUT,IN)
