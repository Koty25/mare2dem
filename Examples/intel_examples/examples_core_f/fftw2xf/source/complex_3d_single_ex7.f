...
!
! Complex-to-complex 3D transform for COMPLEX*8 data inplace with strides and
! threads
!
...
!*****************************************************************************
      ...
      PROGRAM COMPLEX_3D_SINGLE_EX7

      INCLUDE 'fftw_f77.i'
      INCLUDE 'mkl_fftw_examples.fi'

      INTEGER SIZE,N,M,L,IDIST,ISTRIDE,HOWMANY,I,NTHREADS,STATUS
      PARAMETER (M=5)
      PARAMETER (N=8)
      PARAMETER (L=3)
      PARAMETER (ISTRIDE=2)
