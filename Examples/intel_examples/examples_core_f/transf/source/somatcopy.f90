...
!  Content:
!      S O M A T C O P Y  Example Program Text
!*******************************************************************************
    program  SOMATCOPY_MAIN
...
!   Executable Statements
    print*, ' Example of using mkl_somatcopy transposition '
    print*, ' INPUT DATA: '
    print*, ' Source matrix: '    
!   print source matrix           
    do i= 1, 3
...
!
    call MKL_SOMATCOPY('C', & ! column-major ordering
                      &'T', & ! A is transposed
