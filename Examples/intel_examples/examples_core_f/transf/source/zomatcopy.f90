...
!  Content:
!      Z O M A T C O P Y  Example Program Text
!*******************************************************************************
    program  ZOMATCOPY_MAIN
...
!   Executable Statements
    print*, ' Example of using mkl_zomatcopy transposition '
    print*, ' INPUT DATA: '
    print*, ' Source matrix: '    
!   print source matrix           
    do i= 1, 3
...
!
    call MKL_ZOMATCOPY('C',    & ! column-major ordering
                      &'T',    & ! A is transposed
...
!   print source matrix           
    ...
    enddo
! 
!   Submatrix(3,4) is conjugate transposed     
!
    call MKL_ZOMATCOPY('C',    & ! column-major ordering
...
!   print destination matrix      
    print*, 'Destination matrix: '
    print*, 'Submatrix(3,4) is conjugate transposed'
    do i= 1, 4
          print 102,  ( B(i, j), j = 1, 2)
    enddo    
