...
!  Content:
!      C O M A T C O P Y 2  Example Program Text
!*******************************************************************************
    program  COMATCOPY2_MAIN
...
!   Executable Statements
    print*, ' Example of using mkl_comatcopy2 transposition '
    print*, ' INPUT DATA: '
    print*, ' Source matrix: '    
!   print source matrix           
    do i= 1, 3
...
!
    call MKL_COMATCOPY2('C',    & ! column-major ordering
                       &'T',    & ! A is transposed
