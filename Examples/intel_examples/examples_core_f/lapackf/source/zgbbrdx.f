*     ZGBBRD (F08LSF) Example Program Text
...
*     .. Local Arrays ..
      COMPLEX*16       AB(LDAB,NMAX), C(MMAX,NCCMAX), PT(LDPT,NMAX),
     *                 Q(LDQ,MMAX), WORK(MMAX+NMAX)
      DOUBLE PRECISION D(NMAX), E(NMAX-1), RWORK(MMAX+NMAX)
*     .. External Subroutines ..
      EXTERNAL         ZGBBRD
*     .. Intrinsic Functions ..
      INTRINSIC        MAX, MIN
*     .. Executable Statements ..
      WRITE (NOUT,FMT=*) 'ZGBBRD Example Program Results'
