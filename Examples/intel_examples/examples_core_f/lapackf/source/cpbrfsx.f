...
*     .. External Subroutines ..
      ...
      EXTERNAL         CPBRFS, CPBTRF, CPBTRS, CLACPY, CLASET
*     .. Intrinsic Functions ..
      INTRINSIC        MAX, MIN
...
*
         CALL CLASET('General',KD+1,N,ZERO,ZERO,AB,LDAB)
*
...
*
   ...
   40       CONTINUE
         ...
         CALL CLACPY('General',KD+1,N,AB,LDAB,AFB,LDAFB)
