...
*     .. External Subroutines ..
      ...
      EXTERNAL         SLACPY, SLASET, SPBRFS, SPBTRF, SPBTRS
*     .. Intrinsic Functions ..
      INTRINSIC        MAX, MIN
...
*
         CALL SLASET('General',KD+1,N,ZERO,ZERO,AB,LDAB)
*
...
*
         CALL SLACPY('General',KD+1,N,AB,LDAB,AFB,LDAFB)
*
