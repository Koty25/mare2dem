...
*     .. External Subroutines ..
      ...
      EXTERNAL         CGBRFS, CGBTRF, CGBTRS, CLACPY, CLASET
*     .. Intrinsic Functions ..
      INTRINSIC        MAX, MIN
...
*
         CALL CLASET('General',KL+KU+1,N,ZERO,ZERO,AB,LDAB)
*
...
*
     ...
     +     N)
         ...
         CALL CLACPY('General',KL+KU+1,N,AB,LDAB,AFB(KL+1,1),LDAFB)
