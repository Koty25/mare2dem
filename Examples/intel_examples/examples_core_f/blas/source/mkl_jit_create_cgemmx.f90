...
!  Content:
!      MKL_JIT_CREATE_CGEMM  Example Program Text
!*******************************************************************************

include "mkl_blas.f90"

      program   MKL_JIT_CREATE_CGEMM_MAIN
!

      use, intrinsic :: ISO_C_BINDING, only : c_ptr, c_int, c_intptr_t, c_funptr, c_float, c_f_procpointer
      use MKL_JIT_BLAS
      ...
      complex(KIND=c_float)    a(rmaxa,cmaxa), b(rmaxb,cmaxb), c(rmaxc,cmaxc)
      TYPE(C_FUNPTR)           c_kernel

      PROCEDURE(cgemm_jit_kernel_t),POINTER :: f_kernel

!       External Subroutines
      external         PrintArrayC

!
!      Executable Statements
!
      print*
      print*,'   MKL_JIT_CREATE_CGEMM EXAMPLE PROGRAM'
...
!
!      Call MKL_JIT_CREATE_CGEMM subroutine
      ...
      c_kernel = mkl_jit_get_cgemm_ptr(jitter)
