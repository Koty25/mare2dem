...
!  Content:
!      S C G E M M  Example Program Text
!*******************************************************************************
...
*
     ...
     $                 rmaxc=5, cmaxc=5)
      ...
      real             a(rmaxa,cmaxa)
      complex          b(rmaxb,cmaxb), c(rmaxc,cmaxc)
*       External Subroutines
      external        SCGEMM, PrintArrayS, PrintArrayC
*
*      Executable Statements
*
      print*
      print*,'   S C G E M M  EXAMPLE PROGRAM'
*
*      Read input data
      read*
      read*, m, n, k
