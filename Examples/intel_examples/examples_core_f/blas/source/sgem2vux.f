...
!  Content:
!      S G E M 2 V U  Example Program Text
!*******************************************************************************

      program   SGEM2VU_MAIN
*
      ...
      real             alpha, beta
      real             a(mmax,nmax)
      real             x1(x1max), y1(y1max), x2(x2max), y2(y2max)
      integer          i, j
*       Intrinsic Functions
      intrinsic        abs
*       External Subroutines
      external         SGEM2VU, PrintVectorS, PrintArrayS
*
*       Executable Statements
*
      print*
      print*, '   S G E M 2 V U  EXAMPLE PROGRAM'
*
...
*       Print input data
      ...
      call PrintVectorS(0,n,x1,incx1,'X1 ')
      call PrintVectorS(0,m,y1,incy1,'Y1 ')
      call PrintVectorS(0,m,x2,incx2,'X2 ')
      call PrintVectorS(0,n,y2,incy2,'Y2 ')
      call PrintArrayS(0,0,m,n,a,lda,'A')
*
*      Call SGEM2VU subroutine
      call SGEM2VU(m,n,alpha,a,lda,x1,incx1,x2,incx2,
