...
!  Content:
!      MKL_JIT_CREATE_DGEMM  Example Program Text
!*******************************************************************************

include "mkl_blas.f90"

      program   MKL_JIT_CREATE_DGEMM_MAIN
!
      ...
      real(KIND=c_double)      a(rmaxa,cmaxa), b(rmaxb,cmaxb), c(rmaxc,cmaxc)
...
!
      print*
      print*,'   MKL_JIT_CREATE_DGEMM EXAMPLE PROGRAM'
