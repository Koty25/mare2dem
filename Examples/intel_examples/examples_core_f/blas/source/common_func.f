...
!*******************************************************************************
      ...
      subroutine PrintVectorI32(n, x, name)
      integer       n
      character*2   name
      integer*4     x(*)
...
*       Intrinsic Functions
 ...
 102  format(7x,10(f6.2,',',f6.2,3x))
      ...
      subroutine PrintArrayI8(flag1, flag2, m, n, a, lda, name)
 ...
 110  format(9x,10(i8,2x))
 120  format(19x,10(i8,2x))
 130  format(29x,10(i8,2x))
 140  format(39x,10(i8,2x))
 150  format(49x,10(i8,2x))
      return
      end

      subroutine PrintArrayI16(flag1, flag2, m, n, a, lda, name)
      integer           flag1, flag2, m, n, lda
      character*1       name
      integer*2        a(lda,*)
      integer           i, j
 ...
 150  format(49x,10(i8,2x))
      ...
      subroutine PrintArrayI32(flag1, flag2, m, n, a, lda, name)
      integer           flag1, flag2, m, n, lda
      character*1       name
      integer*4        a(lda,*)
      integer           i, j
