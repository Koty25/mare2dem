...
!  Content:
!      D Z G E M M  Example Program Text
!*******************************************************************************
...
*
     ...
     $                rmaxc=5, cmaxc=5)
      ...
      double precision  a(rmaxa,cmaxa)
      complex*16      b(rmaxb,cmaxb), c(rmaxc,cmaxc)
*       External Subroutines
      external        ZGEMM, PrintArrayD, PrintArrayZ
*
*      Executable Statements
*
      print*
      print*,'    D Z G E M M  EXAMPLE PROGRAM'
*
*      Read input data
      read*
      read*, m, n, k
