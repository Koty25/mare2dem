...
!*******************************************************************************
      ...
      call VCMULI(vec_len,cA_I,inca,cA_I,inca,cBha0_I,incb)

      mode=VML_EP
      call VMCMUL(vec_len,cA,cA,cBep1,mode)
      call VMCMULI(vec_len,cA_I,inca,cA_I,inca,cBep1_I,incb,mode)

      tmode=VML_EP
      tmode=VMLSETMODE(tmode)
      call VCMUL(vec_len,cA,cA,cBep2)
      call VCMULI(vec_len,cA_I,inca,cA_I,inca,cBep2_I,incb)

      mode=VML_LA
      call VMCMUL(vec_len,cA,cA,cBla1,mode)
      call VMCMULI(vec_len,cA_I,inca,cA_I,inca,cBla1_I,incb,mode)

      tmode=VML_LA
      tmode=VMLSETMODE(tmode)
      call VCMUL(vec_len,cA,cA,cBla2)
      call VCMULI(vec_len,cA_I,inca,cA_I,inca,cBla2_I,incb)

      mode=VML_HA
      call VMCMUL(vec_len,cA,cA,cBha1,mode)
      call VMCMULI(vec_len,cA_I,inca,cA_I,inca,cBha1_I,incb,mode)

      tmode=VML_HA
      tmode=VMLSETMODE(tmode)
      call VCMUL(vec_len,cA,cA,cBha2)
      call VCMULI(vec_len,cA_I,inca,cA_I,inca,cBha2_I,incb)
      ...
      do i=1,10
          ...
          if(cBha0_I((i-1)*incb+1) .ne. cBha1_I((i-1)*incb+1)) then
              print *,"Error! Difference between VCMULI and"
              print *," VMCMULI in VML_HA mode detected"
              stop 1
          endif
          ...
          if(cBla1_I((i-1)*incb+1) .ne. cBla2_I((i-1)*incb+1)) then
              print *,"Error! Difference between VCMULI and"
              print *," VMCMULI in VML_LA mode detected"
              stop 1
          endif
          ...
          if(cBep1_I((i-1)*incb+1) .ne. cBep2_I((i-1)*incb+1)) then
              print *,"Error! Difference between VCMULI and"
              print *," VMCMULI in VML_EP mode detected"
              stop 1
          endif
      end do
     ...
     &        "========================"
      ...
      print *,""
      print *,"vcMulI test/example program"
      print *,"                    Arguments                         ", &
     &        "      vcMul"
      print *,"======================================================", &
     &        "========================"
