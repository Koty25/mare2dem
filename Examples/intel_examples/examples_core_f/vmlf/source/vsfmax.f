...
!*******************************************************************************
      ...
      call VSFMAX(vec_len,fA1,fA2,fBha0)
      call VSFMAXI(vec_len,fA1_I,inca,fA2_I,incb,fBha0_I,incc)

      mode=VML_EP
      call VMSFMAX(vec_len,fA1,fA2,fBep1,mode)
      call VMSFMAXI(vec_len,fA1_I,inca,fA2_I,incb,fBep1_I,incc,mode)

      tmode=VML_EP
      tmode=VMLSETMODE(tmode)
      call VSFMAX(vec_len,fA1,fA2,fBep2)
      call VSFMAXI(vec_len,fA1_I,inca,fA2_I,incb,fBep2_I,incc)

      mode=VML_LA
      call VMSFMAX(vec_len,fA1,fA2,fBla1,mode)
      call VMSFMAXI(vec_len,fA1_I,inca,fA2_I,incb,fBla1_I,incc,mode)

      tmode=VML_LA
      tmode=VMLSETMODE(tmode)
      call VSFMAX(vec_len,fA1,fA2,fBla2)
      call VSFMAXI(vec_len,fA1_I,inca,fA2_I,incb,fBla2_I,incc)

      mode=VML_HA
      call VMSFMAX(vec_len,fA1,fA2,fBha1,mode)
      call VMSFMAXI(vec_len,fA1_I,inca,fA2_I,incb,fBha1_I,incc,mode)

      tmode=VML_HA
      tmode=VMLSETMODE(tmode)
      call VSFMAX(vec_len,fA1,fA2,fBha2)
      call VSFMAXI(vec_len,fA1_I,inca,fA2_I,incb,fBha2_I,incc)

      do i=1,10
          if(fBha0(i) .ne. fBha1(i)) then
              print *,"Error! Difference between VSFMAX and"
              print *," VMSFMAX in VML_HA mode detected"
              stop 1
          endif
          if(fBha0_I((i-1)*incc+1) .ne. fBha1_I((i-1)*incc+1)) then
              print *,"Error! Difference between VSFMAXI and"
              print *," VMSFMAXI in VML_HA mode detected"
              stop 1
          endif
          ...
          if(fBla1(i) .ne. fBla2(i)) then
              print *,"Error! Difference between VSFMAX and"
              print *," VMSFMAX in VML_LA mode detected"
              stop 1
          endif
          if(fBla1_I((i-1)*incc+1) .ne. fBla2_I((i-1)*incc+1)) then
              print *,"Error! Difference between VSFMAXI and"
              print *," VMSFMAXI in VML_LA mode detected"
              stop 1
          endif
          if(fBep1(i) .ne. fBep2(i)) then
              print *,"Error! Difference between VSFMAX and"
              print *," VMSFMAX in VML_EP mode detected"
              stop 1
          endif
          if(fBep1_I((i-1)*incc+1) .ne. fBep2_I((i-1)*incc+1)) then
              print *,"Error! Difference between VSFMAXI and"
              print *," VMSFMAXI in VML_EP mode detected"
              stop 1
          endif
      end do

      print *,"vsFmax test/example program"
      print *,""
      print *,"           Argument                     vsFmax"
      print *,"======================================================", &
     &        "========================"
      do i=1,10
      ...
      print *,""
      print *,"vsFmaxI test/example program"
      print *,"           Argument                     vsFmax"
      print *,"======================================================", &
     &        "========================"
      do i=1,10
