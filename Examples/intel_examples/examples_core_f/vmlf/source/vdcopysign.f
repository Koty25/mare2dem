...
!*******************************************************************************
      ...
      call VDCOPYSIGN(vec_len,dA1,dA2,dBha0)
      call VDCOPYSIGNI(vec_len,dA1_I,inca,dA2_I,incb,dBha0_I,incc)

      mode=VML_EP
      call VMDCOPYSIGN(vec_len,dA1,dA2,dBep1,mode)
      call VMDCOPYSIGNI(vec_len,dA1_I,inca,dA2_I,incb,dBep1_I,incc,mode)

      tmode=VML_EP
      tmode=VMLSETMODE(tmode)
      call VDCOPYSIGN(vec_len,dA1,dA2,dBep2)
      call VDCOPYSIGNI(vec_len,dA1_I,inca,dA2_I,incb,dBep2_I,incc)

      mode=VML_LA
      call VMDCOPYSIGN(vec_len,dA1,dA2,dBla1,mode)
      call VMDCOPYSIGNI(vec_len,dA1_I,inca,dA2_I,incb,dBla1_I,incc,mode)

      tmode=VML_LA
      tmode=VMLSETMODE(tmode)
      call VDCOPYSIGN(vec_len,dA1,dA2,dBla2)
      call VDCOPYSIGNI(vec_len,dA1_I,inca,dA2_I,incb,dBla2_I,incc)

      mode=VML_HA
      call VMDCOPYSIGN(vec_len,dA1,dA2,dBha1,mode)
      call VMDCOPYSIGNI(vec_len,dA1_I,inca,dA2_I,incb,dBha1_I,incc,mode)

      tmode=VML_HA
      tmode=VMLSETMODE(tmode)
      call VDCOPYSIGN(vec_len,dA1,dA2,dBha2)
      call VDCOPYSIGNI(vec_len,dA1_I,inca,dA2_I,incb,dBha2_I,incc)

      do i=1,10
          if(dBha0(i) .ne. dBha1(i)) then
              print *,"Error! Difference between VDCOPYSIGN and"
              print *," VMDCOPYSIGN in VML_HA mode detected"
              stop 1
          endif
          if(dBha0_I((i-1)*incc+1) .ne. dBha1_I((i-1)*incc+1)) then
              print *,"Error! Difference between VDCOPYSIGNI and"
              print *," VMDCOPYSIGNI in VML_HA mode detected"
              stop 1
          endif
          ...
          if(dBla1(i) .ne. dBla2(i)) then
              print *,"Error! Difference between VDCOPYSIGN and"
              print *," VMDCOPYSIGN in VML_LA mode detected"
              stop 1
          endif
          if(dBla1_I((i-1)*incc+1) .ne. dBla2_I((i-1)*incc+1)) then
              print *,"Error! Difference between VDCOPYSIGNI and"
              print *," VMDCOPYSIGNI in VML_LA mode detected"
              stop 1
          endif
          if(dBep1(i) .ne. dBep2(i)) then
              print *,"Error! Difference between VDCOPYSIGN and"
              print *," VMDCOPYSIGN in VML_EP mode detected"
              stop 1
          endif
          if(dBep1_I((i-1)*incc+1) .ne. dBep2_I((i-1)*incc+1)) then
              print *,"Error! Difference between VDCOPYSIGNI and"
              print *," VMDCOPYSIGNI in VML_EP mode detected"
              stop 1
          endif
      end do

      print *,"vdCopySign test/example program"
      print *,""
      print *,"           Argument                     vdCopySign"
      print *,"======================================================", &
     &        "========================"
      do i=1,10
      ...
      print *,""
      print *,"vdCopySignI test/example program"
      print *,"           Argument                     vdCopySign"
      print *,"======================================================", &
     &        "========================"
      do i=1,10
