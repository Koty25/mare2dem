...
!===============================================================================
      ...
      SUBROUTINE DDCOR(h,inch,x,incx,y,incy,nh,nx,iy0,ny,id)
      USE MKL_VSL_TYPE
      USE MKL_VSL
      IMPLICIT NONE
!
...
!
      ...
      status = vsldcorrnewtask1d(task,mode,nh,nx,ny)
...
!
      ...
      PRINT *, 'ERROR: ddcor(): bad status=',status
      STOP 1
      END IF
!
      IF (error .NE. 0) THEN
      PRINT *, 'ERROR: ddcor(): failed to destroy the task descriptor'
      STOP 1
      END IF
!
      RETURN
