...
!************* Call ddcor ***********/
      ...
      CALL DDCOR( H, INCH, X, INCX, Y, INCY, NH, NX, IY0, NY, ID )

!************* Printing results *****/

      PRINT *, ' 1-ST SAMPLE OF DDCOR.'
      PRINT *, '----------------------'
      PRINT *, 'PARAMETERS:'
      ...
      PRINT *, ' '
       DO I = 1, 6
         IF(DABS(Y(1+(I-1)*INCY)-R1(I)) .GT. R10) THEN
...
!************* Printing results *****/
      ...
      END DO
       DO I = 1, 3
         IF(DABS(Y(1+(I-1)*INCY)-R2(I)) .GT. R10) THEN
         PRINT *, 'ERROR: wrong result: Y(',1+(I-1)*INCY,')'
         PRINT *, '---------------------------'
         PRINT 10, ' TEST FAILED '
         PRINT *, '---------------------------'
