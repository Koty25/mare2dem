...
!     ***** Testing stat characteristics of mean and covariance matrix *****
      call sComputePvalsMean( dim, n, mean, a, C, pval_mean )
      call sComputePvalsVariance( dim, n, cov, C, pval_cov )
      call sComputePvalsCovariance( dim, n, cov, C, pval_cov )
