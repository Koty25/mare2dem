...
!*******************************************************************************
      ...
      brng=VSL_BRNG_MCG31
      method=VSL_RNG_METHOD_LOGNORMAL_BOXMULLER2
      seed=1
...
!     ***** Theoretical moments *****
     ...
     &   (exp(6.0*sigma*sigma)-4.0*exp(3.0*sigma*sigma)+                &
     &   6.0*exp(sigma*sigma)-3.0)
...
!     ***** Printing results *****
      print *,"Sample of vdRngLognormal."
      print *,"-------------------------"
      print *,""
      print *,"Parameters:"
      print 11,"    a=",a
