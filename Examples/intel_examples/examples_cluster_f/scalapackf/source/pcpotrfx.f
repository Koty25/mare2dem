...
!
!      Performance and validation of PCPOTRF function
!
!*******************************************************************************
!
!===============================================================================
...
! INDXG2P
!
! In this example the matrix generated by PCMATGEN is factorized by PCPOTRF.
! For performance measurement only PCPOTRF execution time is taken into
! account.
!
!*******************************************************************************

      PROGRAM PCPOTRF_DRIVER
*     ==== Parameters ==================================================
     ...
     $                     ZERO = ( 0.0E+0, 0.0E+0 ), VERSION = '1.0',
     $                      ONE = 1.0E+0 )
*
*     ==== Local scalars ===============================================
...
*     ==== External subroutines ========================================
     ...
     $         BLACS_GRIDEXIT, BLACS_EXIT, BLACS_BARRIER, PCMATGEN,
     $         PCPOTRF, DESCINIT, IGEBS2D, IGEBR2D, SGEBS2D, SGEBR2D, 
     $         PCLASET, PCLACPY, PCHERK,
     $         CALC_AVERAGE_TIME
*
*     ==== External functions ==========================================
      ...
      EXTERNAL           DSECND, PCLANHE, PSLAMCH, NUMROC, INDXG2P,
     $                   ICEIL, ILCM
*
*     ==== Intrinsic functions =========================================
      INTRINSIC          MAX, DBLE, REAL
*
...
*     Write table header to output
      IF( IAM.EQ.0 ) THEN
         WRITE( NOUT, FMT = 9999 ) 'PCPOTRF performance results'
         WRITE( NOUT, FMT = 9996 )
...
*                 Factor matrix A
                  TIME = DSECND()
                  CALL PCPOTRF( UPLO, N, A, 1, 1, DESCA, INFO )
                  CALL BLACS_BARRIER( ICTXT, 'All' )
                  TIME = DSECND() - TIME
*
                  TIME_ITER( LNCH ) = TIME
...
*                    Copy UPLO part of factorized matrix into a zero matrix
                     CALL PCLASET( 'All', N, N, ZERO, ZERO, A0, 1, 1,
     $                             DESCA0 )
                     CALL PCLACPY( UPLO, N, N, A, 1, 1, DESCA, A0, 1, 1,
     $                             DESCA0 )
*
*                    Regenerate matrix A
                     CALL PCMATGEN( ICTXT, 'Herm', 'Diag', DESCA( M_ ),
...
*                    Calculate norm of the matrix A ( 1 or infinity)
                     ALLOCATE( WORK( LWORK ) )      
                     ANORM = PCLANHE( 'I', UPLO, N, A, 1, 1, DESCA,
     $                                WORK )
*
