...
int main()
{
  ...
  vdAtan2I(vec_len,dA_I,inca,dA_I,inca,dBha0_I,incb);

  vmdAtan2(vec_len,dA,dA,dBep1,VML_EP);
  vmdAtan2I(vec_len,dA_I,inca,dA_I,inca,dBep1_I,incb,VML_EP);

  vmlSetMode(VML_EP);
  vdAtan2(vec_len,dA,dA,dBep2);
  vdAtan2I(vec_len,dA_I,inca,dA_I,inca,dBep2_I,incb);

  vmdAtan2(vec_len,dA,dA,dBla1,VML_LA);
  vmdAtan2I(vec_len,dA_I,inca,dA_I,inca,dBla1_I,incb,VML_LA);

  vmlSetMode(VML_LA);
  vdAtan2(vec_len,dA,dA,dBla2);
  vdAtan2I(vec_len,dA_I,inca,dA_I,inca,dBla2_I,incb);

  vmdAtan2(vec_len,dA,dA,dBha1,VML_HA);
  vmdAtan2I(vec_len,dA_I,inca,dA_I,inca,dBha1_I,incb,VML_HA);

  vmlSetMode(VML_HA);
  vdAtan2(vec_len,dA,dA,dBha2);
  vdAtan2I(vec_len,dA_I,inca,dA_I,inca,dBha2_I,incb);
  ...
  for(i=0;i<10;i++) {
    ...
    if(dBha0_I[i*incb]!=dBha1_I[i*incb] || dBha1_I[i*incb]!=dBha2_I[i*incb]) {
      printf("Error! Difference between vdAtan2I and vmdAtan2I in VML_HA mode detected.\n");
      return 1;
    }
    ...
    if(dBla1_I[i*incb]!=dBla2_I[i*incb]) {
      printf("Error! Difference between vdAtan2I and vmdAtan2I in VML_LA mode detected.\n");
      return 1;
    }
    ...
    if(dBep1_I[i*incb]!=dBep2_I[i*incb]) {
      printf("Error! Difference between vdAtan2I and vmdAtan2I in VML_EP mode detected.\n");
      return 1;
    }
  }
  ...
  printf("\n");
  printf("vdAtan2I test/example program\n\n");
  printf("                     Arguments                               vdAtan2\n");
  printf("===============================================================================\n");
  for(i=0;i<10;i++) {
