...
int main()
{
  ...
  vdAddI(vec_len,dA_I,inca,dA_I,inca,dBha0_I,incb);

  vmdAdd(vec_len,dA,dA,dBep1,VML_EP);
  vmdAddI(vec_len,dA_I,inca,dA_I,inca,dBep1_I,incb,VML_EP);

  vmlSetMode(VML_EP);
  vdAdd(vec_len,dA,dA,dBep2);
  vdAddI(vec_len,dA_I,inca,dA_I,inca,dBep2_I,incb);

  vmdAdd(vec_len,dA,dA,dBla1,VML_LA);
  vmdAddI(vec_len,dA_I,inca,dA_I,inca,dBla1_I,incb,VML_LA);

  vmlSetMode(VML_LA);
  vdAdd(vec_len,dA,dA,dBla2);
  vdAddI(vec_len,dA_I,inca,dA_I,inca,dBla2_I,incb);

  vmdAdd(vec_len,dA,dA,dBha1,VML_HA);
  vmdAddI(vec_len,dA_I,inca,dA_I,inca,dBha1_I,incb,VML_HA);

  vmlSetMode(VML_HA);
  vdAdd(vec_len,dA,dA,dBha2);
  vdAddI(vec_len,dA_I,inca,dA_I,inca,dBha2_I,incb);
  ...
  for(i=0;i<10;i++) {
    ...
    if(dBha0_I[i*incb]!=dBha1_I[i*incb] || dBha1_I[i*incb]!=dBha2_I[i*incb]) {
      printf("Error! Difference between vdAddI and vmdAddI in VML_HA mode detected.\n");
      return 1;
    }
    ...
    if(dBla1_I[i*incb]!=dBla2_I[i*incb]) {
      printf("Error! Difference between vdAddI and vmdAddI in VML_LA mode detected.\n");
      return 1;
    }
    ...
    if(dBep1_I[i*incb]!=dBep2_I[i*incb]) {
      printf("Error! Difference between vdAddI and vmdAddI in VML_EP mode detected.\n");
      return 1;
    }
  }
  ...
  printf("\n");
  printf("vdAddI test/example program\n\n");
  printf("                     Arguments                               vdAdd\n");
  printf("===============================================================================\n");
  for(i=0;i<10;i++) {
