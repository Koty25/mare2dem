...
/*
!  Content:
!      C B L A S _ G E M M _ B F 1 6 B F 1 6 F 3 2
...
int main(int argc, char *argv[])
{
      ...
      printf("\n     C B L A S _ G E M M _ B F 1 6 B F 1 6 F 3 2  EXAMPLE PROGRAM\n");
...
/*      Call SGEMM subroutine ( C Interface )                  */
      ...
      cblas_gemm_bf16bf16f32(layout, transA, transB, m, n, k, alpha,
