...
! multiple DOUBLE-precision complex-to-complex out-of-place 1D FFTs in a single
...
#pragma omp target variant dispatch device(devNum)
    ...
    y = (MKL_Complex16 *)mkl_malloc(numPoints*sizeof(MKL_Complex16), 64);
    ...
    yGPU = (MKL_Complex16 *)mkl_malloc(numPoints*sizeof(MKL_Complex16), 64);
