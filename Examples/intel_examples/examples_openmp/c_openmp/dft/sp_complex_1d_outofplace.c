...
! SINGLE-precision complex-to-complex out-of-place 1D FFT on a CPU or a (GPU)
...
#pragma omp target variant dispatch device(devNum)
    ...
    y = (MKL_Complex8 *)mkl_malloc(N*sizeof(MKL_Complex8), 64);
    ...
    yGPU = (MKL_Complex8 *)mkl_malloc(N*sizeof(MKL_Complex8), 64);
