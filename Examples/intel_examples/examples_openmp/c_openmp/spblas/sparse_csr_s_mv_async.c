...
*             offload example for mkl_sparse_s_mv with async execution
*
********************************************************************************
*
...
#define NNZ 13
    ...
    printf("\n EXAMPLE PROGRAM FOR mkl_sparse_s_mv omp_offload async \n");
    printf("---------------------------------------------------\n");
    printf("\n");
    printf("   INPUT DATA FOR mkl_sparse_s_mv omp offload async   \n");
...
#pragma omp taskwait
    ...
    printf("   OUTPUT DATA FOR mkl_sparse_s_mv_omp_offload async execution.\n");
