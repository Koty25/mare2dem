...
/*
!  Content:
!      oneMKL CBLAS_SGEMV OpenMP offload Example Program Text 
!******************************************************************************/
...
int main() {
    ...
    y_ref = (float *)mkl_malloc(sizey * sizeof(float), 64);
...
#pragma omp target map(y[0:sizey], y_ref[0:sizey])
    ...
    cblas_sgemv(CblasColMajor, CblasNoTrans, m, n, alpha, a, lda, x, incx, beta, y_ref, incy);
