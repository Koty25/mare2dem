...
/*
!  Content:
!      oneMKL CBLAS_DGER OpenMP offload Example Program Text 
!******************************************************************************/
...
int main() {
    ...
    a_ref = (double *)mkl_malloc(sizea * sizeof(double), 64);
...
#pragma omp target map(a[0:sizea], a_ref[0:sizea])
    ...
    cblas_dger(CblasColMajor, m, n, alpha, x, incx, y, incy, a_ref, lda);
