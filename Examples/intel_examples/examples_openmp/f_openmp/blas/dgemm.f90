...
!      FORTRAN OpenMP offload examples for DGEMM
!*******************************************************************************
...
call dcopy_matrix('N', m, n, ldc, c, c_ref)
...
passed = dcheck_matrix(m, n, ldc, c, c_ref)
...
call dprint_matrix(m, n, ldc, c)

print *, "Matrix computed on CPU:"
call dprint_matrix(m, n, ldc, c_ref)
