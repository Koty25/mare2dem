...
integer (kind=4) function test_float(funcname)
    ...
    data test_ref1 / Z'BF50DE70', & ! -0.815894127   
                     Z'3F70389A', & ! 0.938363671    
                     Z'3EF97341', & ! 0.487207443    
                     Z'3F7EC572'  / ! 0.995200276    
...
integer (kind=4) function test_double(funcname)
    ...
    data test_ref1 / Z'BFEA1BCC308CE42E', & ! -0.815893263649859923    
                     Z'3FEE07131CA9A12D', & ! 0.938363605481787766     
                     Z'3FDF2E6881FFD0F4', & ! 0.487207533790992686     
                     Z'3FEFD8AE55A9C5B9'  / ! 0.995200316725621481     
    ! Arguments and reference results end
    ...
    do a = 1, 3
        ...
        !$omp target data map(varg1,vres1)
        !$omp target variant dispatch use_device_ptr(varg1,vres1)
        call vdcospi(VLEN, varg1, vres1)
        !$omp end target variant dispatch
        !$omp end target data
		
        !$omp target data map(varg1,vmres1)
        !$omp target variant dispatch use_device_ptr(varg1,vmres1)
        call vmdcospi(VLEN, varg1, vmres1, vml_accuracy_mode(a))
        !$omp end target variant dispatch
        !$omp end target data
        ! Check results
        do i = 1, VLEN
...
program cospi_example
    ...
    character (len = *), parameter :: funcname = "cospi"
