...
integer (kind=4) function test_float(funcname)
    ...
    data test_ref1 / Z'4065CC38', & ! 3.59058952     
                     Z'3FD2BA03', & ! 1.64630163     
                     Z'404B4F67', & ! 3.17672133     
                     Z'40529713'  / ! 3.29047084     
...
integer (kind=4) function test_double(funcname)
    ...
    data test_ref1 / Z'400CB986F5486496', & ! 3.59058944346595421      
                     Z'3FFA574068B5519B', & ! 1.64630165959997643      
                     Z'400969ECDC82CD04', & ! 3.17672130846188061      
                     Z'400A52E2644589BD'  / ! 3.29047087037289865      
    ! Arguments and reference results end
    ...
    do a = 1, 3
        ...
        !$omp target data map(varg1,vres1)
        !$omp target variant dispatch use_device_ptr(varg1,vres1)
        call vdpow2o3(VLEN, varg1, vres1)
        !$omp end target variant dispatch
        !$omp end target data
		
        !$omp target data map(varg1,vmres1)
        !$omp target variant dispatch use_device_ptr(varg1,vmres1)
        call vmdpow2o3(VLEN, varg1, vmres1, vml_accuracy_mode(a))
        !$omp end target variant dispatch
        !$omp end target data
        ! Check results
        do i = 1, VLEN
...
program pow2o3_example
    ...
    character (len = *), parameter :: funcname = "pow2o3"
