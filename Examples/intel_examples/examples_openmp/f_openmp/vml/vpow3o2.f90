...
integer (kind=4) function test_float(funcname)
    ...
    data test_arg1 / Z'4106AF8C', & ! 8.41785812     
                     Z'408023F8', & ! 4.00439072     
                     Z'40FB492C', & ! 7.85268211     
                     Z'410012AA'  / ! 8.00455666     
    data test_ref1 / Z'41C362B2', & ! 24.4231911     
                     Z'410035F8', & ! 8.01317596     
                     Z'41B00AD4', & ! 22.0052872     
                     Z'41B52C8C'  / ! 22.6467514     
...
integer (kind=4) function test_double(funcname)
    ...
    ! Arguments and reference results begin
    data test_arg1 / Z'4020D5F18943457D', & ! 8.41785839983162454      
                     Z'4010047F1160D5CB', & ! 4.00439097550902101      
                     Z'401F69258D86D24B', & ! 7.85268231521019811      
                     Z'40200255351CD177'  / ! 8.00455633141312539      
    data test_ref1 / Z'40386C564FFCEAF7', & ! 24.4231920235133337      
                     Z'402006BF13594277', & ! 8.01317654099078247      
                     Z'4036015A817DC769', & ! 22.005287259299994       
                     Z'4036A59172F8673B'  / ! 22.6467506271794541      
    ! Arguments and reference results end
    ...
    do a = 1, 3
        ...
        !$omp target data map(varg1,vres1)
        !$omp target variant dispatch use_device_ptr(varg1,vres1)
        call vdpow3o2(VLEN, varg1, vres1)
        !$omp end target variant dispatch
        !$omp end target data
		
        !$omp target data map(varg1,vmres1)
        !$omp target variant dispatch use_device_ptr(varg1,vmres1)
        call vmdpow3o2(VLEN, varg1, vmres1, vml_accuracy_mode(a))
        !$omp end target variant dispatch
        !$omp end target data
        ! Check results
        do i = 1, VLEN
...
program pow3o2_example
    ...
    character (len = *), parameter :: funcname = "pow3o2"
