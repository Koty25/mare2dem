...
integer (kind=4) function test_float(funcname)
    ...
    data test_ref1 / Z'40467000', & ! 3.10058594     
                     Z'400D1AF0', & ! 2.20476913     
                     Z'4040CCB4', & ! 3.01249409     
                     Z'40425949'  / ! 3.03669953     
...
integer (kind=4) function test_double(funcname)
    ...
    data test_ref1 / Z'4008CDFFFECB65A2', & ! 3.1005859285184707       
                     Z'4001A35E121D3680', & ! 2.20476926948214214      
                     Z'40081996870CC042', & ! 3.01249413974440561      
                     Z'40084B2928FBF51B'  / ! 3.0366996004000959       
    ! Arguments and reference results end
    ...
    do a = 1, 3
        ...
        !$omp target data map(varg1,vres1)
        !$omp target variant dispatch use_device_ptr(varg1,vres1)
        call vdlog2(VLEN, varg1, vres1)
        !$omp end target variant dispatch
        !$omp end target data
		
        !$omp target data map(varg1,vmres1)
        !$omp target variant dispatch use_device_ptr(varg1,vmres1)
        call vmdlog2(VLEN, varg1, vmres1, vml_accuracy_mode(a))
        !$omp end target variant dispatch
        !$omp end target data
        ! Check results
        do i = 1, VLEN
...
program log2_example
    ...
    character (len = *), parameter :: funcname = "log2"
