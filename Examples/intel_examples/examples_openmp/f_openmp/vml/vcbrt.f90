...
integer (kind=4) function test_float(funcname)
    ...
    data test_ref1 / Z'3FF28B98', & ! 1.89488506     
                     Z'BFA43C0F', & ! -1.28308284    
                     Z'3FE42395', & ! 1.78233588     
                     Z'3FE83005'  / ! 1.81396544     
...
integer (kind=4) function test_double(funcname)
    ...
    data test_ref1 / Z'3FFE517302E47926', & ! 1.89488507394669048      
                     Z'BFF48781E829ED50', & ! -1.28308287323928383     
                     Z'3FFC8472A9ADC3FC', & ! 1.78233591347475251      
                     Z'3FFD0600B2C39423'  / ! 1.81396550969771719      
    ! Arguments and reference results end
    ...
    do a = 1, 3
        ...
        !$omp target data map(varg1,vres1)
        !$omp target variant dispatch use_device_ptr(varg1,vres1)
        call vdcbrt(VLEN, varg1, vres1)
        !$omp end target variant dispatch
        !$omp end target data
		
        !$omp target data map(varg1,vmres1)
        !$omp target variant dispatch use_device_ptr(varg1,vmres1)
        call vmdcbrt(VLEN, varg1, vmres1, vml_accuracy_mode(a))
        !$omp end target variant dispatch
        !$omp end target data
        ! Check results
        do i = 1, VLEN
...
program cbrt_example
    ...
    character (len = *), parameter :: funcname = "cbrt"
