...
integer (kind=4) function test_float(funcname)
    ...
    data test_ref1 / Z'3F1887C0', & ! 0.595821381    
                     Z'3E776750', & ! 0.241605043    
                     Z'3F33A284', & ! 0.701698542    
                     Z'BE338EF3'  / ! -0.175349995   
...
integer (kind=4) function test_double(funcname)
    ...
    data test_ref1 / Z'3FE310F7F91F8818', & ! 0.595821367806141033     
                     Z'3FCEECE9F755811E', & ! 0.241605039375834829     
                     Z'3FE674509F059EAD', & ! 0.701698599424124603     
                     Z'BFC671DE3ACA66D9'  / ! -0.175349978166926573    
    ! Arguments and reference results end
    ...
    do a = 1, 3
        ...
        !$omp target data map(varg1,varg2,vres1)
        !$omp target variant dispatch use_device_ptr(varg1,varg2,vres1)
        call vdatan2pi(VLEN, varg1, varg2, vres1)
        !$omp end target variant dispatch
        !$omp end target data
		
        !$omp target data map(varg1,varg2,vmres1)
        !$omp target variant dispatch use_device_ptr(varg1,varg2,vmres1)
        call vmdatan2pi(VLEN, varg1, varg2, vmres1, vml_accuracy_mode(a))
        !$omp end target variant dispatch
        !$omp end target data
        ! Check results
        do i = 1, VLEN
...
program atan2pi_example
    ...
    character (len = *), parameter :: funcname = "atan2pi"
