 ...
 *
 *  Content:
 *            oneapi::mkl::vm::fdim example program text (SYCL interface)
 *
 *******************************************************************************/
...
bool vFdimAccuracyLiteTest(const cl::sycl::device &dev) {
...
{ { UINT32_C(0x40D9B85C) }, { UINT32_C(0xC007309A) }, { UINT32_C(0x410EA854) } }, //  0: vsFdim ( 6.80375481     , -2.1123414      ) = ( 8.91609573      );
{ { UINT32_C(0x40B52EFA) }, { UINT32_C(0x40BF006A) }, { UINT32_C(0x00000000) } }, //  1: vsFdim ( 5.66198444     , 5.96880054      ) = ( 0               );
{ { UINT32_C(0x4103BA28) }, { UINT32_C(0xC0C1912F) }, { UINT32_C(0x416482C0) } }, //  2: vsFdim ( 8.2329483      , -6.04897261     ) = ( 14.2819214      );
{ { UINT32_C(0xC052EA36) }, { UINT32_C(0x40ABAABC) }, { UINT32_C(0x00000000) } }, //  3: vsFdim ( -3.2955451     , 5.3645916       ) = ( 0               );
 }
...
{ { UINT64_C(0x401B370B60E66E18) }, { UINT64_C(0xC000E6134801CC26) }, { UINT64_C(0x4021D50A8273AA16) } }, //  0: vdFdim ( 6.80375434309419092      , -2.11234146361813924      ) = ( 8.91609580671233104       );
{ { UINT64_C(0x4016A5DF421D4BBE) }, { UINT64_C(0x4017E00D485FC01A) }, { UINT64_C(0x0000000000000000) } }, //  1: vdFdim ( 5.66198447517211711      , 5.96880066952146571       ) = ( 0                         );
{ { UINT64_C(0x40207744D998EE8A) }, { UINT64_C(0xC0183225E080644C) }, { UINT64_C(0x402C9057C9D920B0) } }, //  2: vdFdim ( 8.23294715873568705      , -6.04897261413232101      ) = ( 14.2819197728680081       );
{ { UINT64_C(0xC00A5D46A314BA8E) }, { UINT64_C(0x4015755793FAEAB0) }, { UINT64_C(0x0000000000000000) } }, //  3: vdFdim ( -3.2955448857022196      , 5.36459189623808186       ) = ( 0                         );
 }
...
,
  ...
  for (int acc = 0; acc < ACCURACY_NUM; ++acc) {
    ...
    oneapi::mkl::vm::fdim(main_queue, varg1.size(), in1, in2, out1, accuracy_mode[acc]);
  ...
  for (auto dev_type : list_of_devices) {
    ...
    if (my_dev_is_found) {
      ...
      std::cout << "\tRunning with single precision real data type:"
                << std::endl;
      errs += vFdimAccuracyLiteTest<float, float>(my_dev);

      std::cout << "\tRunning with double precision real data type:"
                << std::endl;
      errs += vFdimAccuracyLiteTest<double, double>(my_dev);
    } else {
