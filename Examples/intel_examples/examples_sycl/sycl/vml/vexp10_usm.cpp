 ...
 *
 *  Content:
 *            oneapi::mkl::vm::exp10 example program text (SYCL interface)
 *
 *******************************************************************************/
...
bool vExp10AccuracyLiteTest(const cl::sycl::device &dev) {
...
{ { UINT32_C(0x40D9B85C) }, { UINT32_C(0x4AC23992) } }, //  0: vsExp10 ( 6.80375481      ) = ( 6364361         );
{ { UINT32_C(0xC007309A) }, { UINT32_C(0x3BFCFE36) } }, //  1: vsExp10 ( -2.1123414      ) = ( 0.00772073399   );
{ { UINT32_C(0x40B52EFA) }, { UINT32_C(0x48E035B2) } }, //  2: vsExp10 ( 5.66198444      ) = ( 459181.562      );
{ { UINT32_C(0x40BF006A) }, { UINT32_C(0x49633786) } }, //  3: vsExp10 ( 5.96880054      ) = ( 930680.375      );
 }
...
{ { UINT64_C(0x401B370B60E66E18) }, { UINT64_C(0x415847308E0F2A6F) } }, //  0: vdExp10 ( 6.80375434309419092       ) = ( 6364354.2196756443        );
{ { UINT64_C(0xC000E6134801CC26) }, { UINT64_C(0x3F7F9FC67EDE8ECC) } }, //  1: vdExp10 ( -2.11234146361813924      ) = ( 0.00772073304497995425    );
{ { UINT64_C(0x4016A5DF421D4BBE) }, { UINT64_C(0x411C06B6646C72F0) } }, //  2: vdExp10 ( 5.66198447517211711       ) = ( 459181.598069950007       );
{ { UINT64_C(0x4017E00D485FC01A) }, { UINT64_C(0x412C66F13C60E84B) } }, //  3: vdExp10 ( 5.96880066952146571       ) = ( 930680.617926844745       );
 }
...
,
  ...
  for (int acc = 0; acc < ACCURACY_NUM; ++acc) {
    ...
    // Run VM function
    oneapi::mkl::vm::exp10(main_queue, VLEN, varg1, vres1, no_deps, accuracy_mode[acc]);
  ...
  for (auto dev_type : list_of_devices) {
    ...
    if (my_dev_is_found) {
      ...
      std::cout << "\tRunning with single precision real data type:"
                << std::endl;
      errs += vExp10AccuracyLiteTest<float, float>(my_dev);

      std::cout << "\tRunning with double precision real data type:"
                << std::endl;
      errs += vExp10AccuracyLiteTest<double, double>(my_dev);
    } else {
