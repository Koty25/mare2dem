 ...
 *
 *  Content:
 *            oneapi::mkl::vm::log2 example program text (SYCL interface)
 *
 *******************************************************************************/
...
bool vLog2AccuracyLiteTest(const cl::sycl::device &dev) {
...
{ { UINT32_C(0x41093E24) }, { UINT32_C(0x40467000) } }, //  0: vsLog2 ( 8.57767105      ) = ( 3.10058594      );
{ { UINT32_C(0x4093852F) }, { UINT32_C(0x400D1AF0) } }, //  1: vsLog2 ( 4.61000776      ) = ( 2.20476913      );
{ { UINT32_C(0x41011D03) }, { UINT32_C(0x4040CCB4) } }, //  2: vsLog2 ( 8.06958294      ) = ( 3.01249409      );
{ { UINT32_C(0x41034C40) }, { UINT32_C(0x40425949) } }, //  3: vsLog2 ( 8.20611572      ) = ( 3.03669953      );
 }
...
{ { UINT64_C(0x402127C473A3E923) }, { UINT64_C(0x4008CDFFFECB65A2) } }, //  0: vdLog2 ( 8.57767068267691535       ) = ( 3.1005859285184707        );
{ { UINT64_C(0x401270A5F32DAE19) }, { UINT64_C(0x4001A35E121D3680) } }, //  1: vdLog2 ( 4.6100080486899282        ) = ( 2.20476926948214214       );
{ { UINT64_C(0x402023A0651C4741) }, { UINT64_C(0x40081996870CC042) } }, //  2: vdLog2 ( 8.06958309145159269       ) = ( 3.01249413974440561       );
{ { UINT64_C(0x40206988134D9FDD) }, { UINT64_C(0x40084B2928FBF51B) } }, //  3: vdLog2 ( 8.20611629793705255       ) = ( 3.0366996004000959        );
 }
...
,
  ...
  for (int acc = 0; acc < ACCURACY_NUM; ++acc) {
    ...
    // Run VM function
    oneapi::mkl::vm::log2(main_queue, VLEN, varg1, vres1, no_deps, accuracy_mode[acc]);
  ...
  for (auto dev_type : list_of_devices) {
    ...
    if (my_dev_is_found) {
      ...
      std::cout << "\tRunning with single precision real data type:"
                << std::endl;
      errs += vLog2AccuracyLiteTest<float, float>(my_dev);

      std::cout << "\tRunning with double precision real data type:"
                << std::endl;
      errs += vLog2AccuracyLiteTest<double, double>(my_dev);
    } else {
