 ...
 *
 *  Content:
 *            oneapi::mkl::vm::invsqrt example program text (SYCL interface)
 *
 *******************************************************************************/
...
bool vInvSqrtAccuracyLiteTest(const cl::sycl::device &dev) {
...
{ { UINT32_C(0x41093E24) }, { UINT32_C(0x3EAED151) } }, //  0: vsInvSqrt ( 8.57767105      ) = ( 0.341440707     );
{ { UINT32_C(0x4093852F) }, { UINT32_C(0x3EEE7644) } }, //  1: vsInvSqrt ( 4.61000776      ) = ( 0.465746045     );
{ { UINT32_C(0x41011D03) }, { UINT32_C(0x3EB43CB9) } }, //  2: vsInvSqrt ( 8.06958294      ) = ( 0.352025777     );
{ { UINT32_C(0x41034C40) }, { UINT32_C(0x3EB2BB45) } }, //  3: vsInvSqrt ( 8.20611572      ) = ( 0.349085003     );
 }
...
{ { UINT64_C(0x402127C473A3E923) }, { UINT64_C(0x3FD5DA2A2F4A6329) } }, //  0: vdInvSqrt ( 8.57767068267691535       ) = ( 0.341440721685602855      );
{ { UINT64_C(0x401270A5F32DAE19) }, { UINT64_C(0x3FDDCEC86BC084A9) } }, //  1: vdInvSqrt ( 4.6100080486899282        ) = ( 0.465746026255212942      );
{ { UINT64_C(0x402023A0651C4741) }, { UINT64_C(0x3FD687971321A123) } }, //  2: vdInvSqrt ( 8.06958309145159269       ) = ( 0.352025765116666445      );
{ { UINT64_C(0x40206988134D9FDD) }, { UINT64_C(0x3FD657688A01C8D6) } }, //  3: vdInvSqrt ( 8.20611629793705255       ) = ( 0.349084982654983889      );
 }
...
,
  ...
  for (int acc = 0; acc < ACCURACY_NUM; ++acc) {
    ...
    // Run VM function
    oneapi::mkl::vm::invsqrt(main_queue, varg1.size(), in1, out1, accuracy_mode[acc]);
  ...
  for (auto dev_type : list_of_devices) {
    ...
    if (my_dev_is_found) {
      ...
      std::cout << "\tRunning with single precision real data type:"
                << std::endl;
      errs += vInvSqrtAccuracyLiteTest<float, float>(my_dev);

      std::cout << "\tRunning with double precision real data type:"
                << std::endl;
      errs += vInvSqrtAccuracyLiteTest<double, double>(my_dev);
    } else {
