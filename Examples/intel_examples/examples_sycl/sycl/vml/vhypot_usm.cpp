 ...
 *
 *  Content:
 *            oneapi::mkl::vm::hypot example program text (SYCL interface)
 *
 *******************************************************************************/
...
bool vHypotAccuracyLiteTest(const cl::sycl::device &dev) {
...
{ { UINT32_C(0x40D9B85C) }, { UINT32_C(0xC007309A) }, { UINT32_C(0x40E3F8C8) } }, //  0: vsHypot ( 6.80375481     , -2.1123414      ) = ( 7.1241188       );
{ { UINT32_C(0x40B52EFA) }, { UINT32_C(0x40BF006A) }, { UINT32_C(0x4103A212) } }, //  1: vsHypot ( 5.66198444     , 5.96880054      ) = ( 8.22706795      );
{ { UINT32_C(0x4103BA28) }, { UINT32_C(0xC0C1912F) }, { UINT32_C(0x412375B5) } }, //  2: vsHypot ( 8.2329483      , -6.04897261     ) = ( 10.2162371      );
{ { UINT32_C(0xC052EA36) }, { UINT32_C(0x40ABAABC) }, { UINT32_C(0x40C978BB) } }, //  3: vsHypot ( -3.2955451     , 5.3645916       ) = ( 6.29598761      );
 }
...
{ { UINT64_C(0x401B370B60E66E18) }, { UINT64_C(0xC000E6134801CC26) }, { UINT64_C(0x401C7F18D50375CE) } }, //  0: vdHypot ( 6.80375434309419092      , -2.11234146361813924      ) = ( 7.12411816438311796       );
{ { UINT64_C(0x4016A5DF421D4BBE) }, { UINT64_C(0x4017E00D485FC01A) }, { UINT64_C(0x402074424557113D) } }, //  1: vdHypot ( 5.66198447517211711      , 5.96880066952146571       ) = ( 8.22706810653527931       );
{ { UINT64_C(0x40207744D998EE8A) }, { UINT64_C(0xC0183225E080644C) }, { UINT64_C(0x40246EB68D8FA14C) } }, //  2: vdHypot ( 8.23294715873568705      , -6.04897261413232101      ) = ( 10.2162365186528845       );
{ { UINT64_C(0xC00A5D46A314BA8E) }, { UINT64_C(0x4015755793FAEAB0) }, { UINT64_C(0x40192F176CA35836) } }, //  3: vdHypot ( -3.2955448857022196      , 5.36459189623808186       ) = ( 6.29598779437042388       );
 }
...
,
  ...
  for (int acc = 0; acc < ACCURACY_NUM; ++acc) {
    ...
    oneapi::mkl::vm::hypot(main_queue, VLEN, varg1, varg2, vres1, no_deps,
                   accuracy_mode[acc]);
  ...
  for (auto dev_type : list_of_devices) {
    ...
    if (my_dev_is_found) {
      ...
      std::cout << "\tRunning with single precision real data type:"
                << std::endl;
      errs += vHypotAccuracyLiteTest<float, float>(my_dev);

      std::cout << "\tRunning with double precision real data type:"
                << std::endl;
      errs += vHypotAccuracyLiteTest<double, double>(my_dev);
    } else {
