 ...
 *
 *  Content:
 *            oneapi::mkl::vm::atan2pi example program text (SYCL interface)
 *
 *******************************************************************************/
...
bool vAtan2piAccuracyLiteTest(const cl::sycl::device &dev) {
...
{ { UINT32_C(0x40D9B85C) }, { UINT32_C(0xC007309A) }, { UINT32_C(0x3F1887C0) } }, //  0: vsAtan2pi ( 6.80375481     , -2.1123414      ) = ( 0.595821381     );
{ { UINT32_C(0x40B52EFA) }, { UINT32_C(0x40BF006A) }, { UINT32_C(0x3E776750) } }, //  1: vsAtan2pi ( 5.66198444     , 5.96880054      ) = ( 0.241605043     );
{ { UINT32_C(0x4103BA28) }, { UINT32_C(0xC0C1912F) }, { UINT32_C(0x3F33A284) } }, //  2: vsAtan2pi ( 8.2329483      , -6.04897261     ) = ( 0.701698542     );
{ { UINT32_C(0xC052EA36) }, { UINT32_C(0x40ABAABC) }, { UINT32_C(0xBE338EF3) } }, //  3: vsAtan2pi ( -3.2955451     , 5.3645916       ) = ( -0.175349995    );
 }
...
{ { UINT64_C(0x401B370B60E66E18) }, { UINT64_C(0xC000E6134801CC26) }, { UINT64_C(0x3FE310F7F91F8818) } }, //  0: vdAtan2pi ( 6.80375434309419092      , -2.11234146361813924      ) = ( 0.595821367806141033      );
{ { UINT64_C(0x4016A5DF421D4BBE) }, { UINT64_C(0x4017E00D485FC01A) }, { UINT64_C(0x3FCEECE9F755811E) } }, //  1: vdAtan2pi ( 5.66198447517211711      , 5.96880066952146571       ) = ( 0.241605039375834829      );
{ { UINT64_C(0x40207744D998EE8A) }, { UINT64_C(0xC0183225E080644C) }, { UINT64_C(0x3FE674509F059EAD) } }, //  2: vdAtan2pi ( 8.23294715873568705      , -6.04897261413232101      ) = ( 0.701698599424124603      );
{ { UINT64_C(0xC00A5D46A314BA8E) }, { UINT64_C(0x4015755793FAEAB0) }, { UINT64_C(0xBFC671DE3ACA66D9) } }, //  3: vdAtan2pi ( -3.2955448857022196      , 5.36459189623808186       ) = ( -0.175349978166926573     );
 }
...
,
  ...
  for (int acc = 0; acc < ACCURACY_NUM; ++acc) {
    ...
    oneapi::mkl::vm::atan2pi(main_queue, VLEN, varg1, varg2, vres1, no_deps,
                     accuracy_mode[acc]);
  ...
  for (auto dev_type : list_of_devices) {
    ...
    if (my_dev_is_found) {
      ...
      std::cout << "\tRunning with single precision real data type:"
                << std::endl;
      errs += vAtan2piAccuracyLiteTest<float, float>(my_dev);

      std::cout << "\tRunning with double precision real data type:"
                << std::endl;
      errs += vAtan2piAccuracyLiteTest<double, double>(my_dev);
    } else {
