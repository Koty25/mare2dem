 ...
 *
 *  Content:
 *            oneapi::mkl::vm::sqr example program text (SYCL interface)
 *
 *******************************************************************************/
...
bool vSqrAccuracyLiteTest(const cl::sycl::device &dev) {
...
{ { UINT32_C(0x40D9B85C) }, { UINT32_C(0x42392A11) } }, //  0: vsSqr ( 6.80375481      ) = ( 46.2910805      );
{ { UINT32_C(0xC007309A) }, { UINT32_C(0x408EC897) } }, //  1: vsSqr ( -2.1123414      ) = ( 4.46198606      );
{ { UINT32_C(0x40B52EFA) }, { UINT32_C(0x42003B76) } }, //  2: vsSqr ( 5.66198444      ) = ( 32.0580673      );
{ { UINT32_C(0x40BF006A) }, { UINT32_C(0x420E819E) } }, //  3: vsSqr ( 5.96880054      ) = ( 35.6265793      );
 }
...
{ { UINT64_C(0x401B370B60E66E18) }, { UINT64_C(0x40472541E2A5FDA7) } }, //  0: vdSqr ( 6.80375434309419092       ) = ( 46.2910731611730668       );
{ { UINT64_C(0xC000E6134801CC26) }, { UINT64_C(0x4011D912FA710842) } }, //  1: vdSqr ( -2.11234146361813924      ) = ( 4.461986458920423         );
{ { UINT64_C(0x4016A5DF421D4BBE) }, { UINT64_C(0x4040076EC757B843) } }, //  2: vdSqr ( 5.66198447517211711       ) = ( 32.0580681970900727       );
{ { UINT64_C(0x4017E00D485FC01A) }, { UINT64_C(0x4041D033D2046418) } }, //  3: vdSqr ( 5.96880066952146571       ) = ( 35.6265814324798953       );
 }
...
,
  ...
  for (int acc = 0; acc < ACCURACY_NUM; ++acc) {
    ...
    // Run VM function
    oneapi::mkl::vm::sqr(main_queue, VLEN, varg1, vres1, no_deps, accuracy_mode[acc]);
  ...
  for (auto dev_type : list_of_devices) {
    ...
    if (my_dev_is_found) {
      ...
      std::cout << "\tRunning with single precision real data type:"
                << std::endl;
      errs += vSqrAccuracyLiteTest<float, float>(my_dev);

      std::cout << "\tRunning with double precision real data type:"
                << std::endl;
      errs += vSqrAccuracyLiteTest<double, double>(my_dev);
    } else {
