 ...
 *
 *  Content:
 *            oneapi::mkl::vm::arg example program text (SYCL interface)
 *
 *******************************************************************************/
...
bool vArgAccuracyLiteTest(const cl::sycl::device &dev) {
...
{ { UINT32_C(0xC007309A), UINT32_C(0x40D9B85C) }, { UINT32_C(0x3FEF9810) } }, //  0: vcArg ( -2.1123414      + i * 6.80375481      ) = ( 1.87182808      );
{ { UINT32_C(0x40BF006A), UINT32_C(0x40B52EFA) }, { UINT32_C(0x3F424F70) } }, //  1: vcArg ( 5.96880054      + i * 5.66198444      ) = ( 0.75902462      );
{ { UINT32_C(0xC0C1912F), UINT32_C(0x4103BA28) }, { UINT32_C(0x400D15BA) } }, //  2: vcArg ( -6.04897261     + i * 8.2329483       ) = ( 2.20445108      );
{ { UINT32_C(0x40ABAABC), UINT32_C(0xC052EA36) }, { UINT32_C(0xBF0D065C) } }, //  3: vcArg ( 5.3645916       + i * -3.2955451      ) = ( -0.550878286    );
 }
...
{ { UINT64_C(0xC000E6134801CC26), UINT64_C(0x401B370B60E66E18) }, { UINT64_C(0x3FFDF301F34F7D84) } }, //  0: vzArg ( -2.11234146361813924      + i * 6.80375434309419092       ) = ( 1.87182803195159497       );
{ { UINT64_C(0x4017E00D485FC01A), UINT64_C(0x4016A5DF421D4BBE) }, { UINT64_C(0x3FE849EDFE3CD242) } }, //  1: vzArg ( 5.96880066952146571       + i * 5.66198447517211711       ) = ( 0.759024616773395389      );
{ { UINT64_C(0xC0183225E080644C), UINT64_C(0x40207744D998EE8A) }, { UINT64_C(0x4001A2B74AD9EB88) } }, //  2: vzArg ( -6.04897261413232101      + i * 8.23294715873568705       ) = ( 2.20445116498507687       );
{ { UINT64_C(0x4015755793FAEAB0), UINT64_C(0xC00A5D46A314BA8E) }, { UINT64_C(0xBFE1A0CB535C972B) } }, //  3: vzArg ( 5.36459189623808186       + i * -3.2955448857022196       ) = ( -0.550878203216347173     );
 }
  ...
  for (int acc = 0; acc < ACCURACY_NUM; ++acc) {
    ...
    // Run VM function
    oneapi::mkl::vm::arg(main_queue, VLEN, varg1, vres1, no_deps, accuracy_mode[acc]);
  ...
  for (auto dev_type : list_of_devices) {
    ...
    if (my_dev_is_found) {
      ...
      std::cout << "\tRunning with single precision complex data type:"
                << std::endl;
      errs += vArgAccuracyLiteTest<std::complex<float>, float>(my_dev);

      std::cout << "\tRunning with double precision complex data type:"
                << std::endl;
      errs += vArgAccuracyLiteTest<std::complex<double>, double>(my_dev);
