 ...
 *
 *  Content:
 *            oneapi::mkl::vm::expm1 example program text (SYCL interface)
 *
 *******************************************************************************/
...
bool vExpm1AccuracyLiteTest(const cl::sycl::device &dev) {
...
{ { UINT32_C(0x40D9B85C) }, { UINT32_C(0x44610E64) } }, //  0: vsExpm1 ( 6.80375481      ) = ( 900.224854      );
{ { UINT32_C(0xC007309A) }, { UINT32_C(0xBF610921) } }, //  1: vsExpm1 ( -2.1123414      ) = ( -0.879045546    );
{ { UINT32_C(0x40B52EFA) }, { UINT32_C(0x438F5C09) } }, //  2: vsExpm1 ( 5.66198444      ) = ( 286.719025      );
{ { UINT32_C(0x40BF006A) }, { UINT32_C(0x43C304A7) } }, //  3: vsExpm1 ( 5.96880054      ) = ( 390.036346      );
 }
...
{ { UINT64_C(0x401B370B60E66E18) }, { UINT64_C(0x408C21CBAE86A8F2) } }, //  0: vdExpm1 ( 6.80375434309419092       ) = ( 900.224453975706865       );
{ { UINT64_C(0xC000E6134801CC26) }, { UINT64_C(0xBFEC21242FF4658C) } }, //  1: vdExpm1 ( -2.11234146361813924      ) = ( -0.87904557577273712      );
{ { UINT64_C(0x4016A5DF421D4BBE) }, { UINT64_C(0x4071EB813828BC71) } }, //  2: vdExpm1 ( 5.66198447517211711       ) = ( 286.719047698140514       );
{ { UINT64_C(0x4017E00D485FC01A) }, { UINT64_C(0x40786095200E2E6A) } }, //  3: vdExpm1 ( 5.96880066952146571       ) = ( 390.036407523532603       );
 }
...
,
  ...
  for (int acc = 0; acc < ACCURACY_NUM; ++acc) {
    ...
    // Run VM function
    oneapi::mkl::vm::expm1(main_queue, VLEN, varg1, vres1, no_deps, accuracy_mode[acc]);
  ...
  for (auto dev_type : list_of_devices) {
    ...
    if (my_dev_is_found) {
      ...
      std::cout << "\tRunning with single precision real data type:"
                << std::endl;
      errs += vExpm1AccuracyLiteTest<float, float>(my_dev);

      std::cout << "\tRunning with double precision real data type:"
                << std::endl;
      errs += vExpm1AccuracyLiteTest<double, double>(my_dev);
    } else {
