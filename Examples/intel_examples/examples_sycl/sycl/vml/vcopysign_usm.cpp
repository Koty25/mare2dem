 ...
 *
 *  Content:
 *            oneapi::mkl::vm::copysign example program text (SYCL interface)
 *
 *******************************************************************************/
...
bool vCopySignAccuracyLiteTest(const cl::sycl::device &dev) {
...
{ { UINT32_C(0x40D9B85C) }, { UINT32_C(0xC007309A) }, { UINT32_C(0xC0D9B85C) } }, //  0: vsCopySign ( 6.80375481     , -2.1123414      ) = ( -6.80375481     );
{ { UINT32_C(0x40B52EFA) }, { UINT32_C(0x40BF006A) }, { UINT32_C(0x40B52EFA) } }, //  1: vsCopySign ( 5.66198444     , 5.96880054      ) = ( 5.66198444      );
{ { UINT32_C(0x4103BA28) }, { UINT32_C(0xC0C1912F) }, { UINT32_C(0xC103BA28) } }, //  2: vsCopySign ( 8.2329483      , -6.04897261     ) = ( -8.2329483      );
{ { UINT32_C(0xC052EA36) }, { UINT32_C(0x40ABAABC) }, { UINT32_C(0x4052EA36) } }, //  3: vsCopySign ( -3.2955451     , 5.3645916       ) = ( 3.2955451       );
 }
...
{ { UINT64_C(0x401B370B60E66E18) }, { UINT64_C(0xC000E6134801CC26) }, { UINT64_C(0xC01B370B60E66E18) } }, //  0: vdCopySign ( 6.80375434309419092      , -2.11234146361813924      ) = ( -6.80375434309419092      );
{ { UINT64_C(0x4016A5DF421D4BBE) }, { UINT64_C(0x4017E00D485FC01A) }, { UINT64_C(0x4016A5DF421D4BBE) } }, //  1: vdCopySign ( 5.66198447517211711      , 5.96880066952146571       ) = ( 5.66198447517211711       );
{ { UINT64_C(0x40207744D998EE8A) }, { UINT64_C(0xC0183225E080644C) }, { UINT64_C(0xC0207744D998EE8A) } }, //  2: vdCopySign ( 8.23294715873568705      , -6.04897261413232101      ) = ( -8.23294715873568705      );
{ { UINT64_C(0xC00A5D46A314BA8E) }, { UINT64_C(0x4015755793FAEAB0) }, { UINT64_C(0x400A5D46A314BA8E) } }, //  3: vdCopySign ( -3.2955448857022196      , 5.36459189623808186       ) = ( 3.2955448857022196        );
 }
...
,
  ...
  for (int acc = 0; acc < ACCURACY_NUM; ++acc) {
    ...
    oneapi::mkl::vm::copysign(main_queue, VLEN, varg1, varg2, vres1, no_deps,
                      accuracy_mode[acc]);
  ...
  for (auto dev_type : list_of_devices) {
    ...
    if (my_dev_is_found) {
      ...
      std::cout << "\tRunning with single precision real data type:"
                << std::endl;
      errs += vCopySignAccuracyLiteTest<float, float>(my_dev);

      std::cout << "\tRunning with double precision real data type:"
                << std::endl;
      errs += vCopySignAccuracyLiteTest<double, double>(my_dev);
    } else {
