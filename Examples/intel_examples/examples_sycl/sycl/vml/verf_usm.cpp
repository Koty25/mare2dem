 ...
 *
 *  Content:
 *            oneapi::mkl::vm::erf example program text (SYCL interface)
 *
 *******************************************************************************/
...
bool vErfAccuracyLiteTest(const cl::sycl::device &dev) {
...
{ { UINT32_C(0x3F2E2D16) }, { UINT32_C(0x3F29FF1C) } }, //  0: vsErf ( 0.680375457     ) = ( 0.66404891      );
{ { UINT32_C(0xBE584DC4) }, { UINT32_C(0xBE707D97) } }, //  1: vsErf ( -0.211234152    ) = ( -0.234854087    );
{ { UINT32_C(0x3F10F262) }, { UINT32_C(0x3F13A33B) } }, //  2: vsErf ( 0.566198468     ) = ( 0.576709449     );
{ { UINT32_C(0x3F18CD22) }, { UINT32_C(0x3F19F50C) } }, //  3: vsErf ( 0.596880078     ) = ( 0.601395369     );
 }
...
{ { UINT64_C(0x3FE5C5A2B3EB8B46) }, { UINT64_C(0x3FE53FE388571266) } }, //  0: vdErf ( 0.680375434309419047      ) = ( 0.664048925675683632      );
{ { UINT64_C(0xBFCB09B873361370) }, { UINT64_C(0xBFCE0FB2D80C1EAA) } }, //  1: vdErf ( -0.211234146361813924     ) = ( -0.234854083530298852     );
{ { UINT64_C(0x3FE21E4C34E43C98) }, { UINT64_C(0x3FE2746759551790) } }, //  2: vdErf ( 0.566198447517211711      ) = ( 0.576709436871839287      );
{ { UINT64_C(0x3FE319A439E63348) }, { UINT64_C(0x3FE33EA175373E87) } }, //  3: vdErf ( 0.596880066952146571      ) = ( 0.601395348488907966      );
 }
...
,
  ...
  for (int acc = 0; acc < ACCURACY_NUM; ++acc) {
    ...
    // Run VM function
    oneapi::mkl::vm::erf(main_queue, VLEN, varg1, vres1, no_deps, accuracy_mode[acc]);
  ...
  for (auto dev_type : list_of_devices) {
    ...
    if (my_dev_is_found) {
      ...
      std::cout << "\tRunning with single precision real data type:"
                << std::endl;
      errs += vErfAccuracyLiteTest<float, float>(my_dev);

      std::cout << "\tRunning with double precision real data type:"
                << std::endl;
      errs += vErfAccuracyLiteTest<double, double>(my_dev);
    } else {
