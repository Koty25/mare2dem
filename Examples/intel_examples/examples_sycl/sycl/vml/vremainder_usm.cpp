 ...
 *
 *  Content:
 *            oneapi::mkl::vm::remainder example program text (SYCL interface)
 *
 *******************************************************************************/
...
bool vRemainderAccuracyLiteTest(const cl::sycl::device &dev) {
...
{ { UINT32_C(0x40D9B85C) }, { UINT32_C(0xC007309A) }, { UINT32_C(0x3EEEF750) } }, //  0: vsRemainder ( 6.80375481     , -2.1123414      ) = ( 0.466730595     );
{ { UINT32_C(0x40B52EFA) }, { UINT32_C(0x40BF006A) }, { UINT32_C(0xBE9D1700) } }, //  1: vsRemainder ( 5.66198444     , 5.96880054      ) = ( -0.306816101    );
{ { UINT32_C(0x4103BA28) }, { UINT32_C(0xC0C1912F) }, { UINT32_C(0x400BC642) } }, //  2: vsRemainder ( 8.2329483      , -6.04897261     ) = ( 2.1839757       );
{ { UINT32_C(0xC052EA36) }, { UINT32_C(0x40ABAABC) }, { UINT32_C(0x40046B42) } }, //  3: vsRemainder ( -3.2955451     , 5.3645916       ) = ( 2.0690465       );
 }
...
{ { UINT64_C(0x401B370B60E66E18) }, { UINT64_C(0xC000E6134801CC26) }, { UINT64_C(0x3FDDDEE74E3BBDF0) } }, //  0: vdRemainder ( 6.80375434309419092      , -2.11234146361813924      ) = ( 0.466729952239773205      );
{ { UINT64_C(0x4016A5DF421D4BBE) }, { UINT64_C(0x4017E00D485FC01A) }, { UINT64_C(0xBFD3A2E0642745C0) } }, //  1: vdRemainder ( 5.66198447517211711      , 5.96880066952146571       ) = ( -0.306816194349348592     );
{ { UINT64_C(0x40207744D998EE8A) }, { UINT64_C(0xC0183225E080644C) }, { UINT64_C(0x400178C7A562F190) } }, //  2: vdRemainder ( 8.23294715873568705      , -6.04897261413232101      ) = ( 2.18397454460336604       );
{ { UINT64_C(0xC00A5D46A314BA8E) }, { UINT64_C(0x4015755793FAEAB0) }, { UINT64_C(0x40008D6884E11AD2) } }, //  3: vdRemainder ( -3.2955448857022196      , 5.36459189623808186       ) = ( 2.06904701053586226       );
 }
...
,
  ...
  for (int acc = 0; acc < ACCURACY_NUM; ++acc) {
    ...
    oneapi::mkl::vm::remainder(main_queue, VLEN, varg1, varg2, vres1, no_deps,
                       accuracy_mode[acc]);
  ...
  for (auto dev_type : list_of_devices) {
    ...
    if (my_dev_is_found) {
      ...
      std::cout << "\tRunning with single precision real data type:"
                << std::endl;
      errs += vRemainderAccuracyLiteTest<float, float>(my_dev);

      std::cout << "\tRunning with double precision real data type:"
                << std::endl;
      errs += vRemainderAccuracyLiteTest<double, double>(my_dev);
    } else {
