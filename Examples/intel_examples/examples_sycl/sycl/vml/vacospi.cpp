 ...
 *
 *  Content:
 *            oneapi::mkl::vm::acospi example program text (SYCL interface)
 *
 *******************************************************************************/
...
bool vAcospiAccuracyLiteTest(const cl::sycl::device &dev) {
...
{ { UINT32_C(0x3F2E2D16) }, { UINT32_C(0x3E860CD7) } }, //  0: vsAcospi ( 0.680375457     ) = ( 0.26181671      );
{ { UINT32_C(0xBE584DC4) }, { UINT32_C(0x3F1157F3) } }, //  1: vsAcospi ( -0.211234152    ) = ( 0.567748249     );
{ { UINT32_C(0x3F10F262) }, { UINT32_C(0x3E9DE862) } }, //  2: vsAcospi ( 0.566198468     ) = ( 0.308413565     );
{ { UINT32_C(0x3F18CD22) }, { UINT32_C(0x3E97C2A2) } }, //  3: vsAcospi ( 0.596880078     ) = ( 0.296406806     );
 }
...
{ { UINT64_C(0x3FE5C5A2B3EB8B46) }, { UINT64_C(0x3FD0C19AFA2583F6) } }, //  0: vdAcospi ( 0.680375434309419047      ) = ( 0.261816734584555788      );
{ { UINT64_C(0xBFCB09B873361370) }, { UINT64_C(0x3FE22AFE6445C016) } }, //  1: vdAcospi ( -0.211234146361813924     ) = ( 0.567748256535199003      );
{ { UINT64_C(0x3FE21E4C34E43C98) }, { UINT64_C(0x3FD3BD0C52F35C07) } }, //  2: vdAcospi ( 0.566198447517211711      ) = ( 0.308413582807986975      );
{ { UINT64_C(0x3FE319A439E63348) }, { UINT64_C(0x3FD2F85444FAAB98) } }, //  3: vdAcospi ( 0.596880066952146571      ) = ( 0.296406810152512801      );
 }
...
,
  ...
  for (int acc = 0; acc < ACCURACY_NUM; ++acc) {
    ...
    // Run VM function
    oneapi::mkl::vm::acospi(main_queue, varg1.size(), in1, out1, accuracy_mode[acc]);
  ...
  for (auto dev_type : list_of_devices) {
    ...
    if (my_dev_is_found) {
      ...
      std::cout << "\tRunning with single precision real data type:"
                << std::endl;
      errs += vAcospiAccuracyLiteTest<float, float>(my_dev);

      std::cout << "\tRunning with double precision real data type:"
                << std::endl;
      errs += vAcospiAccuracyLiteTest<double, double>(my_dev);
    } else {
