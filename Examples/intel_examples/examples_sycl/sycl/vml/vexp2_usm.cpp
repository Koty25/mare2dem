 ...
 *
 *  Content:
 *            oneapi::mkl::vm::exp2 example program text (SYCL interface)
 *
 *******************************************************************************/
...
bool vExp2AccuracyLiteTest(const cl::sycl::device &dev) {
...
{ { UINT32_C(0x40D9B85C) }, { UINT32_C(0x42DF7115) } }, //  0: vsExp2 ( 6.80375481      ) = ( 111.720863      );
{ { UINT32_C(0xC007309A) }, { UINT32_C(0x3E6CD267) } }, //  1: vsExp2 ( -2.1123414      ) = ( 0.231271371     );
{ { UINT32_C(0x40B52EFA) }, { UINT32_C(0x424A876A) } }, //  2: vsExp2 ( 5.66198444      ) = ( 50.6322403      );
{ { UINT32_C(0x40BF006A) }, { UINT32_C(0x427A85F2) } }, //  3: vsExp2 ( 5.96880054      ) = ( 62.630806       );
 }
...
{ { UINT64_C(0x401B370B60E66E18) }, { UINT64_C(0x405BEE22060061FC) } }, //  0: vdExp2 ( 6.80375434309419092       ) = ( 111.72082662618044        );
{ { UINT64_C(0xC000E6134801CC26) }, { UINT64_C(0x3FCD9A4CCC8509B5) } }, //  1: vdExp2 ( -2.11234146361813924      ) = ( 0.231271362174153033      );
{ { UINT64_C(0x4016A5DF421D4BBE) }, { UINT64_C(0x404950ED51D23267) } }, //  2: vdExp2 ( 5.66198447517211711       ) = ( 50.6322424198486303       );
{ { UINT64_C(0x4017E00D485FC01A) }, { UINT64_C(0x404F50BE6F64D25A) } }, //  3: vdExp2 ( 5.96880066952146571       ) = ( 62.6308116190236461       );
 }
...
,
  ...
  for (int acc = 0; acc < ACCURACY_NUM; ++acc) {
    ...
    // Run VM function
    oneapi::mkl::vm::exp2(main_queue, VLEN, varg1, vres1, no_deps, accuracy_mode[acc]);
  ...
  for (auto dev_type : list_of_devices) {
    ...
    if (my_dev_is_found) {
      ...
      std::cout << "\tRunning with single precision real data type:"
                << std::endl;
      errs += vExp2AccuracyLiteTest<float, float>(my_dev);

      std::cout << "\tRunning with double precision real data type:"
                << std::endl;
      errs += vExp2AccuracyLiteTest<double, double>(my_dev);
    } else {
