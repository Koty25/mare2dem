 ...
 *
 *  Content:
 *            oneapi::mkl::vm::erfcinv example program text (SYCL interface)
 *
 *******************************************************************************/
...
bool vErfcInvAccuracyLiteTest(const cl::sycl::device &dev) {
...
{ { UINT32_C(0x3F57E803) }, { UINT32_C(0x3E0F0DBE) } }, //  0: vsErfcInv ( 0.843383968     ) = ( 0.13970086      );
{ { UINT32_C(0x3ED02026) }, { UINT32_C(0x3F16428E) } }, //  1: vsErfcInv ( 0.406495273     ) = ( 0.586953044     );
{ { UINT32_C(0x3F49957D) }, { UINT32_C(0x3E433D7D) } }, //  2: vsErfcInv ( 0.78743726      ) = ( 0.190664247     );
{ { UINT32_C(0x3F4D6EC1) }, { UINT32_C(0x3E3520C9) } }, //  3: vsErfcInv ( 0.80247122      ) = ( 0.176882878     );
 }
...
{ { UINT64_C(0x3FEAFD005D47E586) }, { UINT64_C(0x3FC1E1B7D3A5B285) } }, //  0: vdErfcInv ( 0.843383962811615318      ) = ( 0.139700868934046124      );
{ { UINT64_C(0x3FDA0404BAD030FF) }, { UINT64_C(0x3FE2C851C4CA7D32) } }, //  1: vdErfcInv ( 0.406495268282711153      ) = ( 0.586953052861565405      );
{ { UINT64_C(0x3FE932AF94CBFEF9) }, { UINT64_C(0x3FC867AFB9967916) } }, //  2: vdErfcInv ( 0.787437239283433787      ) = ( 0.190664258593593317      );
{ { UINT64_C(0x3FE9ADD8269C5173) }, { UINT64_C(0x3FC6A4190C656C3E) } }, //  3: vdErfcInv ( 0.80247123280655186       ) = ( 0.176882868817161254      );
 }
...
,
  ...
  for (int acc = 0; acc < ACCURACY_NUM; ++acc) {
    ...
    // Run VM function
    oneapi::mkl::vm::erfcinv(main_queue, varg1.size(), in1, out1, accuracy_mode[acc]);
  ...
  for (auto dev_type : list_of_devices) {
    ...
    if (my_dev_is_found) {
      ...
      std::cout << "\tRunning with single precision real data type:"
                << std::endl;
      errs += vErfcInvAccuracyLiteTest<float, float>(my_dev);

      std::cout << "\tRunning with double precision real data type:"
                << std::endl;
      errs += vErfcInvAccuracyLiteTest<double, double>(my_dev);
    } else {
