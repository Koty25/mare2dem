 ...
 *
 *  Content:
 *            oneapi::mkl::vm::cospi example program text (SYCL interface)
 *
 *******************************************************************************/
...
bool vCospiAccuracyLiteTest(const cl::sycl::device &dev) {
...
{ { UINT32_C(0x40D9B85C) }, { UINT32_C(0xBF50DE70) } }, //  0: vsCospi ( 6.80375481      ) = ( -0.815894127    );
{ { UINT32_C(0xC007309A) }, { UINT32_C(0x3F70389A) } }, //  1: vsCospi ( -2.1123414      ) = ( 0.938363671     );
{ { UINT32_C(0x40B52EFA) }, { UINT32_C(0x3EF97341) } }, //  2: vsCospi ( 5.66198444      ) = ( 0.487207443     );
{ { UINT32_C(0x40BF006A) }, { UINT32_C(0x3F7EC572) } }, //  3: vsCospi ( 5.96880054      ) = ( 0.995200276     );
 }
...
{ { UINT64_C(0x401B370B60E66E18) }, { UINT64_C(0xBFEA1BCC308CE42E) } }, //  0: vdCospi ( 6.80375434309419092       ) = ( -0.815893263649859923     );
{ { UINT64_C(0xC000E6134801CC26) }, { UINT64_C(0x3FEE07131CA9A12D) } }, //  1: vdCospi ( -2.11234146361813924      ) = ( 0.938363605481787766      );
{ { UINT64_C(0x4016A5DF421D4BBE) }, { UINT64_C(0x3FDF2E6881FFD0F4) } }, //  2: vdCospi ( 5.66198447517211711       ) = ( 0.487207533790992686      );
{ { UINT64_C(0x4017E00D485FC01A) }, { UINT64_C(0x3FEFD8AE55A9C5B9) } }, //  3: vdCospi ( 5.96880066952146571       ) = ( 0.995200316725621481      );
 }
...
,
  ...
  for (int acc = 0; acc < ACCURACY_NUM; ++acc) {
    ...
    // Run VM function
    oneapi::mkl::vm::cospi(main_queue, VLEN, varg1, vres1, no_deps, accuracy_mode[acc]);
  ...
  for (auto dev_type : list_of_devices) {
    ...
    if (my_dev_is_found) {
      ...
      std::cout << "\tRunning with single precision real data type:"
                << std::endl;
      errs += vCospiAccuracyLiteTest<float, float>(my_dev);

      std::cout << "\tRunning with double precision real data type:"
                << std::endl;
      errs += vCospiAccuracyLiteTest<double, double>(my_dev);
    } else {
