...
*       DPCPP API oneapi::mkl::sparse::symv to perform
*symmetrical
...
*
*
*       The supported floating point data types for symv matrix data are:
*           float
*           double
*
*
...
int run_sparse_matrix_vector_multiply_example(const cl::sycl::device &dev)
{
    ...
    oneapi::mkl::uplo uploA = oneapi::mkl::uplo::lower;
    ...
    std::cout << "\t\t\tuploA = " << (uploA == oneapi::mkl::uplo::upper ? "upper" : "lower")
              << std::endl;
