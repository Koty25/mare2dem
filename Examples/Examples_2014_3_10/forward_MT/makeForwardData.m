%
% This is an example of MATLAB to code to create a dummy MT data file that
...
slopePos   = topo(1:end-1,1) + dy/2;
beta       = interp1(slopePos ,slopeAngle,yRx);
...
%
% Initialize the other structures to empty
%
stUTM =[];
stCSEM = [];
