#line 1 "/home/users/fpmjunior/mare2dem-omeep-newest/em2dkx.f90"
!-----------------------------------------------------------------------
!
!    Copyright 2008-2018
!    Kerry Key
...
!======================================================================================================================== em2dkx_mod
!==================================================================================================================================!  
#include </home/users/fpmjunior/scorep/include/scorep/SCOREP_User.inc>
...
#ifdef TRACE
    SCOREP_USER_REGION_DEFINE(estimateerror)
	
    SCOREP_USER_REGION_BEGIN( estimateerror, "estimateerror", SCOREP_USER_REGION_TYPE_COMMON ) 
#endif 
...
#ifdef TRACE    
    SCOREP_USER_REGION_END( estimateerror ) !end Instrumentation
#endif
...
#ifdef TRACE
    SCOREP_USER_REGION_DEFINE(comp_adj_derivs)
	
    SCOREP_USER_REGION_BEGIN( comp_adj_derivs, "comp_adj_derivs", SCOREP_USER_REGION_TYPE_COMMON ) 
#endif
...
#ifdef TRACE    
    SCOREP_USER_REGION_END( comp_adj_derivs ) !end Instrumentation
#endif
...
#ifdef TRACE
    SCOREP_USER_REGION_DEFINE(localrefinement)
	
    SCOREP_USER_REGION_BEGIN( localrefinement, "localrefinement", SCOREP_USER_REGION_TYPE_COMMON ) 
#endif
...
#ifdef TRACE
    SCOREP_USER_REGION_DEFINE(gen_lhs)
	
    SCOREP_USER_REGION_BEGIN( gen_lhs, "gen_lhs", SCOREP_USER_REGION_TYPE_COMMON ) 
#endif
...
#ifdef TRACE    
    SCOREP_USER_REGION_END( gen_lhs ) !end Instrumentation
#endif   
...
#ifdef TRACE
    SCOREP_USER_REGION_DEFINE(solve_primal)
	
    SCOREP_USER_REGION_BEGIN( solve_primal, "solve_primal", SCOREP_USER_REGION_TYPE_COMMON ) 
#endif 
...
#ifdef TRACE    
    SCOREP_USER_REGION_END( solve_primal ) !end Instrumentation
#endif
